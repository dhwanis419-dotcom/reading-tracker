...
import type { WorkType, Priority, FictionStatus } from '@/lib/types';
...
export default function AddItemForm({ onAdded }: { onAdded: () => void }) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // Simple duplicate check: same title + type, case-insensitive.
      ...
      if (existing && existing.length > 0) {
        // Reuse the existing Work rather than creating a duplicate.
